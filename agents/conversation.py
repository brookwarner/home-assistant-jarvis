...
_MODE_LAYERS = {
    ...
    "proactive": (
        ...
        "When the context asks for a recommendation pass, send at most one concrete recommendation. "
        ...
        "If the context includes 'Selected recommendation:', only phrase that recommendation — "
